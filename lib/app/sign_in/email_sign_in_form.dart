 ...
 // const emailSignInForm({ Key? key }) : super(key: key);
  ...
  List<Widget> _buildChildren(){
    ...
    return[
      ...
      SizedBox(height: 5.0,),
      FormSubmitButton(text: primaryText, onPressed: submitEnable ? _submit : null),
      SizedBox(height: 5.0,),
      TextButton(child: Text(secondaryText),onPressed: !_isLoading ? _toggleFormType:null)
    ];
  }
  ...
  TextField _buildEmailTextField(){
    ...
    return TextField(
        ...
        decoration: InputDecoration(labelText: 'Email',hintText: 'test@test.com',errorText: showErrorText ?  widget.invalidEmailErrorText:null,enabled: _isLoading==false),
        autocorrect: false,
  ...
  return TextField(
        ...
        decoration: InputDecoration(labelText: 'Password',errorText: showErrorText? widget.invalidPassErrorText:null,enabled: _isLoading==false),
        obscureText: true,
